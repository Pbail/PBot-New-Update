...
👋 <b>𝖧𝖾𝗒,<a href='tg://user?id=${id}'>${name}</a></b>
<b>Mʏ Nᴀᴍᴇ Is,@${botUsername}!</b> 🤖
<b>◈ Ｉ Ａᴍ ᴍᴏᴠɪᴇ , ᴡᴇʙ ꜱᴇʀɪᴇꜱ ᴀɴᴅ ᴀɴɪᴍᴇ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ
<br>
        ◈ Ｉ Ａᴍ ʏᴏᴜʀ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɪ ꜰɪʟᴇ ᴍᴀɴᴀɢᴇʀ, ᴅᴇꜱɪɢɴᴇᴅ ᴛᴏ ꜱᴛʀᴇᴀᴍʟɪɴᴇ ʏᴏᴜʀ ꜰɪʟᴇ ꜱʜᴀʀɪɴɢ ᴇxᴘᴇʀɪᴇɴᴄᴇ.
        <br>
        ◈ ᴡɪᴛʜ ᴍᴇ, ʏᴏᴜ ᴄᴀɴ ᴇꜰꜰᴏʀᴛʟᴇꜱꜱʟʏ ɢᴇɴᴇʀᴀᴛᴇ ꜱʜᴀʀᴇᴀʙʟᴇ ʟɪɴᴋꜱ ꜰᴏʀ ʏᴏᴜʀ ꜰɪʟᴇꜱ!<b>
